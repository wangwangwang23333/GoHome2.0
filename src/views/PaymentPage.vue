      ...
      <el-container style="width: 100%;">
        <el-aside style="width: 40%;margin-left: 15%;">
         ...
         ">
            <div slot="header">
              <el-container>
                <el-main>
                  <el-image
                      v-if="dataReady===true"
                      :src="thisRoom.roomImage"
                      :alt="thisRoom.roomImage"
                      style="height: 90px;
                 width: 105px;
                 position: relative;
                 border-radius:10px;
            ...
            <div>
              <p align="left">&yen;{{ thisRoom.price }} x {{ day_count }}晚</p>
              <p align="right">&yen;{{ day_count * thisRoom.price }}</p>
            </div>
<!--            <div-->
...
<!--            </div>-->
            <div>
              <p align="left">服务费</p>
              <p align="right">&yen; 5</p>
            </div>
            <div>
              <h4 align="left">总价</h4>
              <h4 align="right">&yen; 100</h4>
            </div>
          </el-card>
          ...
          <el-card style="padding-bottom: 5%;">
            ...
            <div>
              ...
              <h3 style=" vertical-align: middle; height: 25px;">
                <el-image src="https://oliver-img.oss-cn-shanghai.aliyuncs.com/img/edf24647e3ffa658b15a77e849ba566b.png"
                          style="width: 25px; height: 25px; float:left;  vertical-align: middle;"></el-image>
...
<!--                      <el-link @click="handleChangeDateOpen" v-show="false">编辑</el-link>-->
            ...
            <div>
              <h3 style="vertical-align: middle; height: 25px;">
                <el-image src="https://oliver-img.oss-cn-shanghai.aliyuncs.com/img/529df86b2cffba7b2c207cac3aae3f2b.png"
                          style="width: 25px; height: 25px; float:left;  vertical-align: middle;"></el-image>
                <span style="vertical-align: middle; float: left;margin-left: 1%;">人数</span>
                <span style="float: right;">
      ...
      <div style="
        ...
        <el-link :underline="false" style="float: left;"><strong style="text-decoration:underline; font-size: 16px;"
                                                                 @click="houseRulesDialogVisible = true;">房屋守则</strong>
        </el-link>
        <el-dialog
            title="入住须知"
...
export default {
  ...
  data() {
    return {
      ...
      // payObj: {
      //   text: "",
      //   // logo: require('@/assets/logo/smallLogo.png')
      // }
    }
  },
  methods: {
